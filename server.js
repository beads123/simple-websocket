...
var WebSocketConnection=function(req,socket,upgradeHead){
    ...
    socket.write('HTTP/1.1 101 Socket Protocal Handshake\r\n'+
            'Upgrade: WebSocket\r\n'+
            'Connection: Upgrade\r\n'+
...
WebSocketConnection.prototype.send=function(obj){
    ...
    if(Buffer.isBuffer(obj)){
        ...
        throw new Error("can not send object,must be string or Buffer");
    }
...
WebSocketConnection.prototype._handleFrame=function(opcode,buffer){
    ...
    switch(opcode){
        ...
        case opcodes.CLOSE:
            ...
            break;
        default :
            this.close(1002,"unkonwn opcode");
    }
}
